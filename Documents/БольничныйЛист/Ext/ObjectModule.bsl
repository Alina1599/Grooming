...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	|    Начисления.ВидРасчета.СтатьиЗатрат КАК СтатьиЗатрат
	|ИЗ
	...
	|    Начисления.ВидРасчета.СтатьиЗатрат";
	...
	ДвижениеЗатрат.СтатьяЗатрат = Выборка.СтатьиЗатрат;    
	...
	ДвижениеХозрасчетный.СубконтоДт, Выборка.СтатьиЗатрат);
